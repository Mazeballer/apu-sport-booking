  ...
  if (confirmedBookings.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground">There are no confirmed bookings at the moment</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        <Button variant={filterMode === "all" ? "default" : "outline"} size="sm" onClick={handleAllFilter}>
          All Bookings
        </Button>
        <Button variant={filterMode === "today" ? "default" : "outline"} size="sm" onClick={handleTodayFilter}>
          Today
        </Button>
        <Popover>
          ...
          <PopoverContent className="w-auto p-0" align="start">
            <Calendar mode="single" selected={selectedDate} onSelect={handleCustomDate} initialFocus />
          </PopoverContent>
        </Popover>
        {filterMode !== "all" && (
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {booking.equipment.length > 0 && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{booking.equipment.length} items</span>
                        </div>
                      )}
                    </div>
                  </div>
